    ...
    const mailOptions = {
      ...
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; padding: 20px; border: 1px solid #ddd; border-radius: 10px; background-color: #f9f9f9;">
        ...
        <div style="text-align: center; margin: 30px 0;">
          <a href="https://game-vault-backend-9vh9.vercel.app/mail/verified-email/${tokenGenerated}" style="padding: 15px 25px; color: #fff; background-color: #28a745; text-decoration: none; border-radius: 5px; font-size: 16px;">
            Confirm Account
          </a>
        </div>
        <p style="font-size: 14px; color: #777;">
          ...
          <br/>
          <a href="https://game-vault-backend-9vh9.vercel.app/mail/verified-email/${tokenGenerated}" style="color: #007bff;">https://game-vault-backend-9vh9.vercel.app/mail/verified-email/${tokenGenerated}</a>
        </p>
